...
class SongScores():
    ...
    def compare_not_found(comparison_submission: "SongComparison", song1: "ScoreObject", song2: "ScoreObject"):
    ...
    def update_song_rating(comparison_submission: "SongComparison", song1: "ScoreObject", song2: "ScoreObject", score_range=30):
        ...
        if SongScores.compare_not_found(comparison_submission, song1, song2):
            ...
            song1.quality_score, song2.quality_score = elo_rating(song1.quality_score, song2.quality_score, score_range, comparison_submission.first_better)


            song1.energy_score, song2.energy_score = elo_rating(song1.energy_score, song2.energy_score, score_range, comparison_submission.first_peakier)


            song1.post_peak_score, song2.post_peak_score = elo_rating(song1.post_peak_score, song2.post_peak_score, score_range, comparison_submission.first_post_peakier) 
